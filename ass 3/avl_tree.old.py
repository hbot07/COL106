...
class BinaryTree:
    ...
    # def less_than_or_equal(self, upper_bound):
    #     return self.less_than_or_equal_helper(self.root, upper_bound)
    #
    # def less_than_or_equal_helper(self, root, upper_bound):
    #     if root is not None:
    #         if root.data > upper_bound:
    #             return self.less_than_or_equal_helper(root.left, upper_bound)
    #         else:
    #             return self.in_order(root.left) + [root.data] + \
    #                    self.less_than_or_equal_helper(root.right, upper_bound)
    #     else:
    #         return []
...
# tree1.insert(6)
# tree1.insert(20)
# print(tree1.in_order(tree1.root))
# tree1.right_rotate(tree1.root)
# print(tree1.in_order(tree1.root))
# tree1.left_rotate(tree1.root)
# print(tree1.less_than_or_equal(100))
# print(tree1.root.left.parent.height)
# tree1.print_tree()
...
for i in [6, 4, 7, 9, 1, 3]:
    tree2.insert(i)
# print("height", tree2.get_height(tree2.root))
# print(tree2.less_than_or_equal(100))
tree2.print_tree()
